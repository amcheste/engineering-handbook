...
- [Centralized CI design note](docs/design/centralized-ci-workflows.md) status updated to Implemented: v1.0.0/v1.0.1/v1.1.0 released, template and fleet conversion PRs open, monthly fleet audit scheduled (Epsilon task, 2nd of each month), open questions resolved.
